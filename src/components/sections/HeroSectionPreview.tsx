...
import { IdentityCardV2 } from "@/components/identity-card/IdentityCardV2";
...
export function HeroSectionPreview() {
  ...
  useEffect(() => {
    ...
    if (flair) gsap.set(flair, { xPercent: -50, yPercent: -50, scale: 0 });
        ...
        <div className="grid grid-cols-1 items-center gap-10 py-12 lg:grid-cols-2 lg:gap-14">
          ...
          >
            ...
            <div className="animate-bob">
              <IdentityCardV2 data={liveCard ?? DEMO_CARD} interactive={false} />
            </div>
          </motion.div>
        </div>
      </div>
